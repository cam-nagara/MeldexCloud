...
(function (global) {
  const types = [
    ...
    { type: 'furigana', label: 'ふりがな', icon: 'superscript' },
    { type: 'number', label: '数値', icon: 'hash' },
    { type: 'select', label: 'セレクト', icon: 'layoutList' },
    { type: 'multi-select', label: 'マルチセレクト', icon: 'layoutList' },
    { type: 'common-tags', label: '共通タグ', icon: 'tags' },
