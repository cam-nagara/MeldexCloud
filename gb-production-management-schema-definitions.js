(function () {
  ...
  const ROOT = '制作管理';
  const relation = (target, multiple = false, required = false) => ({
  ...
  const PROPERTY_TYPES = {
    ...
    '作品リスト': {
      '使用する作業テンプレート': relation('作業テンプレート'),
      'ページ数': { type: 'number' },
    ...
    'タスクテンプレート': {
      '作業テンプレート': relation('作業テンプレート', false, true),
      'テンプレート名': { type: 'text' },
      'タスク名': { type: 'text' },
      '順番': { type: 'number' },
      '標準時間': { type: 'number' },
  ...
  const SEEDS = {
    '作業内容リスト': [
      ...
      ['ネーム', { '作業順': '25', '作業時間倍率': '1' }],
      ['下描き', { '作業順': '30', '作業時間倍率': '1' }],
      ['3D配置', { '作業順': '35', '作業時間倍率': '1' }],
      ['ペン入れ', { '作業順': '40', '作業時間倍率': '1' }],
      ['仕上げ', { '作業順': '50', '作業時間倍率': '1' }],
      ['制作', { '作業順': '30', '作業時間倍率': '1' }],
      ['確認', { '作業順': '40', '作業時間倍率': '1' }],
      ['修正', { '作業順': '50', '作業時間倍率': '1' }],
      ['完了処理', { '作業順': '60', '作業時間倍率': '1' }],
    ],
    '作業対象リスト': [
      ['全体', { '基準作業時間': '1' }],
      ['主要部分', { '基準作業時間': '1' }],
